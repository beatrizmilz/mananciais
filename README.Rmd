...
- `mananciais` - 2000 à 2019 - [Baixar versão `.csv`](https://github.com/beatrizmilz/mananciais/raw/master/data/mananciais.csv)

- `mananciais_atualizado` - 2000 à 2020 (parcial) - [Baixar versão `.csv`](https://github.com/beatrizmilz/mananciais/raw/master/data/mananciais_atualizado.csv)
